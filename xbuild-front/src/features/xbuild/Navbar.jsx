...
const STYLE = `
  ...
  @media (max-width: 1000px) {
    ...
    .navbar-white-panel { width: 60% !important; }
    .navbar-accent { width: calc(60% + 10px) !important; }
  }
`;
...
export default function Navbar({ active, info }) {
  ...
  // Total header height = topbar (36px) + main bar (72px) = 108px
  const TOTAL_H = 108;
  ...
  return (
    <>
      ...
      <header style={{
        ...
        {/* ── TOP BAR: phone · email · language ── desktop only ─────────────── */}
